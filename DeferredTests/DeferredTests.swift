...
func dispatch_main_after(interval: TimeInterval, block: @escaping () -> ()) {
...
class DeferredTests: XCTestCase {
    ...
    func testConcurrentUpon() {
        ...
        DispatchQueue.global(qos:.default).async { d.fill(1) }
    ...
    func testAny() {
        ...
        d[3].fill(3)
        let expect = expectation(description:"any is filled")
        DispatchQueue.global(qos:.default).async {
            while !w.isFilled { /* spin */ }
